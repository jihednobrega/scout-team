...
interface MatchInsightButtonProps {
  teamId: string
  matchId: string
}
...
export function MatchInsightButton({ teamId, matchId }: MatchInsightButtonProps) {
  ...
  const fetchInsight = useCallback(async () => {
    ...
    setText(null)
    try {
      const params = new URLSearchParams({ type: 'match_analysis', teamId, matchId })
              ...
              {isEmpty && !isLoading && (
                <Flex direction="column" align="center" py={8} gap={3}>
                  ...
                  <Text textAlign="center"
                    style={{ fontFamily: FONT_BODY, fontSize: '13px', color: 'rgba(255,255,255,0.3)', lineHeight: 1.6 }}
                  >
