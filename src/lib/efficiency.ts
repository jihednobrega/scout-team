...
const SCOUT_EFFICIENCY: Record<string, Record<string, number>> = {
  ...
  opponent_error: { serve_error: 1.0, attack_error: 1.0, block_error: 1.0, set_error: 1.0, violation: 1.0, error: 1.0 },
  opponent_point: { kill: -1.0, ace: -1.0, block_point: -1.0, error: -1.0 },
}
